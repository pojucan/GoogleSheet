...
pasta_id = 'id_da_sua_pasta_do_google_sheet' # É uma seguência alfanumérica

# Planilha data da pasta data no Google Sheets:
planilha_name = 'data'

url = f'https://docs.google.com/spreadsheets/d/id_da_sua_pasta_do_google_sheet/gviz/tq?tqx=out:csv&sheet={planilha_name}'
